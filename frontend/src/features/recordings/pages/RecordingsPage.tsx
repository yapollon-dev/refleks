...
export function RecordingsPage() {
  ...
  const obsProcessLabel = status?.obsProcessStatus || 'not_checked'
    ...
    <div className="flex flex-1 flex-col overflow-hidden text-sm">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-5">
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <div className="rounded-xl bg-surface px-5 py-4 shadow-sm">
            <div className="text-xs uppercase tracking-wide text-surface-muted-foreground">OBS running</div>
            <div className="mt-2 text-base font-medium text-foreground">{formatLabel(obsProcessLabel)}</div>
          </div>
          <div className="rounded-xl bg-surface px-5 py-4 shadow-sm">
            <div className="text-xs uppercase tracking-wide text-surface-muted-foreground">Replay buffer</div>
            <div className="mt-2 text-base font-medium text-foreground">{formatLabel(replayStatusLabel)}</div>
          </div>
          <div className="rounded-xl bg-surface px-5 py-4 shadow-sm">
        ...
        <div className="mt-4 rounded-xl bg-surface px-5 py-4 shadow-sm">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3 xl:grid-cols-6">
            <div className="rounded-lg bg-surface-subtle px-3 py-2">
              <div className="text-xs text-surface-muted-foreground">Storage used</div>
              <div className="mt-1 text-sm font-medium text-foreground">{formatBytes(status?.totalSizeBytes ?? 0)}</div>
            </div>
            <div className="rounded-lg bg-surface-subtle px-3 py-2">
              <div className="text-xs text-surface-muted-foreground">Storage limit</div>
              <div className="mt-1 text-sm font-medium text-foreground">{formatBytes(storageLimit)}</div>
            </div>
            <div className="rounded-lg bg-surface-subtle px-3 py-2">
