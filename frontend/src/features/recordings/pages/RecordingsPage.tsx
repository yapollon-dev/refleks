...
import { getRecordings, getRecordingStatus } from '@/shared/lib'
      ...
      <div className="sticky top-0 z-10 bg-canvas/95 px-5 py-4 backdrop-blur">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-surface-muted-foreground">OBS replay metadata and storage controls will appear here</p>
          </div>
